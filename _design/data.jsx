// Sample data for AlbAuto prototype
...
const MK_CITIES = ['Skopje','Bitola','Kumanovo','Prilep','Tetovo','Ohrid','Veles','Štip','Gostivar','Strumica','Kavadarci'];

const MAKES = ['Abarth','Acura','AITO','Al Damani','Alfa Romeo','Ariel','Ashok Leyland','Aston Martin','Audi','Aurus','BMW','BYD','Cadillac','Chevrolet','Citroën','Cupra','Dacia','Dodge'];

const BMW_MODELS = ['1 Series','2 Series','3 Series','4 Series','5 Series','6 Series','7 Series','8 Series','X1','X2','X3','X4','X5','X6','X7','M2','M3','M4','M5','M8'];
...
const EU_COUNTRIES = ['Austria','Belgium','Croatia','Czechia','Denmark','Finland','France','Germany','Greece','Hungary','Italy','Netherlands','Poland','Portugal','Romania','Spain','Sweden','Switzerland'];
...
Object.assign(window, { CARS, BALKAN_COUNTRIES, MK_CITIES, MAKES, BMW_MODELS, CONTINENTS, EU_COUNTRIES, CHATS });
